    ...
    <>
      ...
      <section style={s.wrapper}>
        <div style={s.content} className="hero-content">
          <div
            style={{ ...s.left, ...(mounted ? s.fadeInL : {}) }}
            className="hero-left"
          >
            ...
            <h2 style={s.sub} className="hero-sub">
              Designing tech that actually moves people
            </h2>

            <p style={s.blurb} className="hero-blurb">
              Full‑stack dev & data whisperer. Turning wild ideas into polished,
              production‑ready reality.
            </p>

            <a
              href="/Khushali_Begde_Resume.pdf"
              target="_blank"
...
const s = {
  ...
  gradient: {
    background: "linear-gradient(90deg,#f8eadd,#dfcabe)",
  ...
  cta: {
    ...
    boxShadow: "0 8px 20px rgba(202,170,130,0.25)",
    transition: "all .35s",
  },
  ctaHover: {
